<%@ Page Title="" Language="C#" MasterPageFile="~/AapnoGharWebMaster.Master" AutoEventWireup="true" CodeBehind="indexmain.aspx.cs" Inherits="AapnoGharWeb.indexmain" %>
                ...
                <ItemTemplate>
                    <div class="item">
                        <a href="/eat-and-drink-offer">
                            <%# Convert.ToString(Eval("EatAndDrinkBannerImage")) != "" ? "<div class='video'><video id='myVid' muted loop autoplay src='/AapnoGharlmages/EatAndDrinkImages/"+Eval("EatAndDrinkBannerImage")+"'></video><img class='poster' src='/AapnoGharlmages/EatAndDrinkImages/"+Eval("EatAndDrinkDefaultImage")+"' alt='"+Eval("EatAndDrinkAlias")+"' title='"+Eval("EatAndDrinkName")+"'/></div>":"<figure><img src='/AapnoGharlmages/EatAndDrinkImages/"+Eval("EatAndDrinkDefaultImage")+"' alt='"+Eval("EatAndDrinkAlias")+"' title='"+Eval("EatAndDrinkName")+"'/></figure>" %>
                            <div class="info"><p><%#Eval("EatAndDrinkName")%></p></div>
                        </a>
                    </div>
                </ItemTemplate>
            </asp:Repeater>--%>
            <div class="item">
                <a href="/meet-and-celebrations">
                    <%--<figure><img src="assets/images/home/img3.jpg" alt="" /></figure>--%>
                    <div class="video"><video id="myVid1" muted="" loop="" autoplay="" src="/assets/video/meet-and-celebrations.mp4"></video><img class="poster" src="assets/images/home/img3.jpg" alt="Meeting & Celebrations" title="Meeting & Celebrations"></div>
                    <div class="info"><p>Meeting & Celebrations</p></div>
                </a>
            </div>
            <div class="item">
                <a href="/stay">
...
<section>
    <div class="home_secA">
        <div class="container">
            <div class="flex">
                <div class="colA">
                    <figure><img src="assets/icons/Loader-BIG.gif" alt="" /></figure>
                </div>
                <div class="colB">
                    <div class="content">
                        ...
                        <div class="counter_sec">
                            <div class="count-info">
                                <h3><span class="count" data-count="35">0</span></h3>
                                <p>Years of experience</p>
                            </div>
                            <div class="count-info">
                                <h3><span class="count" data-count="21">0</span></h3>
                                <p>Thrilling rides</p>
                            </div>
                            <div class="count-info">
                                <h3><span class="count" data-count="24">0</span></h3>
                                <p>Adventure activities</p>
                            </div>
                            <div class="count-info">
                                <h3><span class="count" data-count="60">0</span></h3>
                ...
                <div class="cola_wrapper">
                    <div class="col_bx">
                        <asp:Repeater ID="RptrPackageData" runat="server">
                            <ItemTemplate>
                                <div class="card" data-attr="tab<%#Eval("PackageID") %>" <%# Container.ItemIndex == 0 ? "style='display: block;'":"style='display: none;'" %>>
                                    <div class="top_con">
                                        <div class="heading">
                                            <h2><%#Eval("PackageTitle") %></h2>
                                            <div class="line"><img src="assets/icons/heading_line.png" alt="" /></div>
                                        </div>
                                    ...
                                    <div class="mid_con">
                                        ...
                                        <div class="pakage_pr">
                                            <div class="col" id="PnlKids" runat="server" visible='<%# Convert.ToInt16(Eval("KidsPrice")) > 0 ? true:false %>'>
                                                <figure><img src="assets/icons/kids.gif" alt="" /></figure>
                                                <div class="info_pakg">
                                            ...
                                            <div class="col" id="PnlAdults" runat="server" visible='<%# Convert.ToInt16(Eval("AdultPrice")) > 0 ? true:false %>'>
                                                <figure><img src="assets/icons/adult.gif" alt="" /></figure>
                                                <div class="info_pakg">
...
<section>
    <div class="home_secC" id="pnlCouponsData" runat="server" visible="false">
        <div class="bg">
            <figure><img src="assets/images/home/secC_banner.jpg" alt="" /></figure>
        </div>
        <div class="secC_wrapper">
            <div class="container">
                <asp:Repeater ID="RptrCouponsData" runat="server">
                    <ItemTemplate>
                        <div class="content">
                            <figure><img src="assets/images/home/secC_ico.png" alt="" /></figure>
                            <div class="info_abt">
    ...
    <div class="home_secD">
        <div class="container">
            <div class="heading text-center">
                ...
                <div class="tsd_btn"><a href="https://test.aapnoghar.com/aapno360/suite-room.html" target="_blank">360&#176;</a></div>
            </div>
...
<section id="pnlWeddeingEventType" runat="server" visible="false">
    <div class="home_secE">
        <div class="secE-wrapper">
            ...
            <div class="link_btn red_btn"><a href="/meet-and-celebrations">View All</a></div>
        </div>
    </div>
</section>
<section>
        ...
        <div class="content_f">
            <div class="testi_demo">
                <div class="testi-slider owl-carousel">
                    <div class="item">
                        <div class="card">
                            <div class="upper_ico"><img src="assets/icons/testi_ico.png" alt="" /></div>
                                ...
                                <ItemTemplate>
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="icon_vdo">
                                                <div class="video_icon model-video model-open" data-model=".Model_Video" data-video="<%#Eval("VideoURL")%>?autoplay=1"><img src="assets/icons/play.png" alt="" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </ItemTemplate>
